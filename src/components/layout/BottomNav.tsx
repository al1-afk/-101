...
/* La liste et la règle d'accès vivent dans ./raccourcis : le bandeau de
   l'ordinateur montre exactement les mêmes quatre pages, et deux copies
...
export default function BottomNav() {
  ...
  const bareTop = sectionCourante(location.pathname, tenantSlug)
